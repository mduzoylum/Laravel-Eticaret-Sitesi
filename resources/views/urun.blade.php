        ...
        <div class="bg-content">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <a href="#" class="thumbnail"><img src="https://via.placeholder.com/60x60.png?text=Resim 1"></a>
                        </div>
                        <div class="col-xs-3">
                            <a href="#" class="thumbnail"><img src="https://via.placeholder.com/60x60.png?text=Resim 2"></a>
                        </div>
                        <div class="col-xs-3">
                            <a href="#" class="thumbnail"><img src="https://via.placeholder.com/60x60.png?text=Resim 3"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-7">
